...
describe('PaginationControlsComponent:', () => {
  ...
  it('should display the correct page links (formatted numbers over 1000) with comma', fakeAsync(() => {
    const fixture = TestBed.createComponent(ComponentTestComponent);
    const instance = fixture.componentInstance;
    instance.collection = Array.from(
      new Array(1000),
      (x, i) => `item ${i + 1}`
    );
  ...
  it('should add "ellipsis" class to ellipsis links', fakeAsync(() => {
    ...
    const listItems = fixture.debugElement
      .queryAll(By.css('mod-pagination-controls li'))
      .filter(
        (el) =>
          (el.nativeElement as HTMLLIElement).classList.contains(
            'small-screen'
          ) === false
      )
    ...
    expect(
      listItems[2] ? listItems[2].classList.contains('ellipsis') : false
    ).toBe(true);
    tick();
    expect(
      listItems[8] ? listItems[8].classList.contains('ellipsis') : false
    ).toBe(true);
  }));
  ...
  it('should highlight the currently-active page when currentPage is passed as a numeric string', fakeAsync(() => {
    ...
    const current: DebugElement = fixture.debugElement.query(
      By.css('.current')
    );
  ...
  it('should allow the pagination-controls to come before the PaginatePipe', () => {
    overrideTemplate(
      ComponentTestComponent,
      `
            <mod-pagination-controls [id]="config.id"></mod-pagination-controls>
            <ul>
  ...
  it('should allow multiple independent instances (controller test)', () => {
    overrideTemplate(
      ...
      `
            ...
            <mod-pagination-controls id="test1"></mod-pagination-controls>
            <ul class="list2">
               <li *ngFor="let item of collection | paginate: {id: 'test2', itemsPerPage: 10, currentPage: p2 }"
                   class="list-item">{{ item }}</li>
            </ul>
            <mod-pagination-controls id="test2"></mod-pagination-controls>`
    );
    ...
    const controls: PaginationControlsDirective[] = fixture.debugElement
      .queryAll(By.css('mod-pagination-template'))
      .map((el) => el.references.pApi);
  ...
  it('should allow multiple independent instances (template test)', fakeAsync(() => {
    overrideTemplate(
      ...
      `
            ...
            <mod-pagination-controls id="test1" (pageChange)="p1 = $event"></mod-pagination-controls>
            <ul class="list2">
               <li *ngFor="let item of collection | paginate: {id: 'test2', itemsPerPage: 10, currentPage: p2 }"
                   class="list-item">{{ item }}</li>
            </ul>
            <mod-pagination-controls id="test2" (pageChange)="p2 = $event"></mod-pagination-controls>`
    );
    ...
    const controls: DebugElement[] = fixture.debugElement.queryAll(
      By.css('mod-pagination-template')
    );
    const controlsDirectives: PaginationControlsDirective[] = controls.map(
      (el) => el.references['pApi']
    );
  ...
  it('"autoHide" should be boolean', () => {
    const fixture = TestBed.createComponent(ComponentTestComponent);
    const controlsInstance = fixture.debugElement.query(
      By.css('mod-pagination-controls')
    ).componentInstance;
  ...
  it('"autoHide" should work with non-data-bound values', () => {
    overrideTemplate(
      ...
      `
            ...
            <mod-pagination-controls autoHide="false" [id]="config.id"></mod-pagination-controls>`
    );
    const fixture = TestBed.createComponent(ComponentTestComponent);
    fixture.detectChanges();
  ...
  it('"directionLinks" should work with non-data-bound values', () => {
    overrideTemplate(
      ...
      `
            ...
            <mod-pagination-controls directionLinks="false" [id]="config.id"></mod-pagination-controls>`
    );
    const fixture = TestBed.createComponent(ComponentTestComponent);
    fixture.detectChanges();
    const controlsCmp: PaginationControlsComponent = fixture.debugElement.query(
  ...
  it('"directionLinks" state should be reflected in default template', fakeAsync(() => {
    ...
    const instance = fixture.componentInstance;
    let items;
    items = getPageLinkItems(fixture, 'mod-pagination-controls li', true);
  ...
  it('"responsive" should work with non-data-bound values', () => {
    overrideTemplate(
      ...
      `
            ...
            <mod-pagination-controls responsive="true" [id]="config.id"></mod-pagination-controls>`
    );
    const fixture = TestBed.createComponent(ComponentTestComponent);
    fixture.detectChanges();
    const controlsCmp: PaginationControlsComponent = fixture.debugElement.query(
  ...
  it('"responsive" state should be reflected in default template', () => {
    ...
    const list = fixture.debugElement.query(By.css('ul.mod-pagination'));
    ...
    it('previousLabel should bind in correct locations', fakeAsync(() => {
      overrideTemplate(
        ...
        `
                   ...
                   <mod-pagination-controls previousLabel="${TEST_LABEL}" id="test"></mod-pagination-controls>`
      );
      const fixture = TestBed.createComponent(ComponentTestComponent);
      const instance = fixture.componentInstance;
      ...
      // expect(prevSpan.textContent.replace(/\n/, ' ')).toContain(expected);

      instance.config.currentPage = 2;
      fixture.detectChanges();

      const prevA = fixture.debugElement.query(
        By.css('.pagination-previous > a')
      ).nativeElement;
      tick();
      expect(prevA.textContent.replace(/\n/, ' ')).toContain(expected);
      tick();
    ...
    it('nextLabel should bind in correct locations', fakeAsync(() => {
      overrideTemplate(
        ...
        `
                   ...
                   <mod-pagination-controls nextLabel="${TEST_LABEL}" id="test"></mod-pagination-controls>`
      );
      const fixture = TestBed.createComponent(ComponentTestComponent);
      const instance = fixture.componentInstance;
      const expected = `${TEST_LABEL} page`;
      ...
      const nextA = fixture.debugElement.query(By.css('.pagination-next > a'))
        .nativeElement;
      tick();
      expect(nextA.textContent.replace(/\n/, ' ')).toContain(expected);
      tick();
      ...
      // expect(nextSpan.textContent.replace(/\n/, '')).toContain(expected);
    }));
    ...
    it('screenReaderPaginationLabel should bind in correct locations', fakeAsync(() => {
      overrideTemplate(
        ...
        `
                           ...
                           <mod-pagination-controls screenReaderPaginationLabel="${TEST_LABEL}" id="test"></mod-pagination-controls>`
      );
      const fixture = TestBed.createComponent(ComponentTestComponent);
      fixture.detectChanges();

      const paginationUl = fixture.debugElement.query(
        By.css('ul.mod-pagination')
      ).nativeElement;
      tick();
    ...
    it('screenReaderPageLabel should bind in correct locations', fakeAsync(() => {
      overrideTemplate(
        ...
        `
                   ...
                   <mod-pagination-controls screenReaderPageLabel="${TEST_LABEL}" id="test"></mod-pagination-controls>`
      );
      const fixture = TestBed.createComponent(ComponentTestComponent);
      const instance = fixture.componentInstance;
      ...
      tick();
      const pageA = fixture.debugElement.queryAll(
        By.css('.mod-pagination li > a')
      )[1].nativeElement;
      expect(pageA.textContent.replace(/\n/, ' ')).toContain(`${TEST_LABEL} 1`);
    }));
    ...
    it('screenReaderCurrentLabel should bind in correct locations', fakeAsync(() => {
      overrideTemplate(
        ...
        `
                   ...
                   <mod-pagination-controls screenReaderCurrentLabel="${TEST_LABEL}" id="test"></mod-pagination-controls>`
      );
      const fixture = TestBed.createComponent(ComponentTestComponent);
      ...
      const currentPage = fixture.debugElement.query(
        By.css('.mod-pagination li.current .show-for-sr')
      ).nativeElement;
      expect(currentPage.textContent).toContain(`${TEST_LABEL}`);
    }));
  });
});
