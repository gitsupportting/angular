...
describe('Service: ObUtilsService', () => {
  ...
  it('should check if date is in range', inject(
    ...
    (service: UtilsService) => {
      ...
      expect(
        service.isDateInRange(moment(), moment().subtract(1, 'd'), null)
      ).toBeFalsy();
      expect(
        service.isDateInRange(
          moment().subtract(2, 'd'),
  ...
  it('should convertPropsToMoment method', inject(
    [UtilsService],
    (service: UtilsService) => {
  ...
  it('should test datesStringToStringArray', inject(
    ...
    (service: UtilsService) => {
      ...
      expect(
        service.datesStringToStringArray('14-01-1984|15-01-1984')
  ...
  it('check convertToString', inject(
    ...
    (service: UtilsService) => {
      ...
      expect(service.convertToString(moment(), format)).toEqual(
      ...
      expect(
        service.convertToString([moment(), moment().add(1, 'd')], format)
      ).toEqual(
        moment().format(format) + ' | ' + moment().add(1, 'd').format(format)
      );
      expect(
