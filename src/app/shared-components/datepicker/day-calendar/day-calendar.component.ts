...
export class DayCalendarComponent
  ...
  @Output() onNavHeaderBtnClick: EventEmitter<
    ECalendarMode
  > = new EventEmitter();
  ...
  getDayBtnCssClass(day: IDay): { [klass: string]: boolean } {
    const cssClasses: { [klass: string]: boolean } = {
      'mod-selected': day.selected,
      'mod-current-month': day.currentMonth,
      'mod-prev-month': day.prevMonth,
      'mod-next-month': day.nextMonth,
      'mod-current-day': day.currentDay,
    };
