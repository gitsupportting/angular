...
export class DatePickerComponent
  ...
  set selected(selected: Moment[]) {
    ...
    this.inputElementValue = (this.utilsService.convertFromMomentArray(
  ...
  setElementPositionInDom(): void {
    ...
    this.popupElem = this.elemRef.nativeElement.querySelector('.mod-popup');
  ...
  setInputElementContainer() {
    this.inputElementContainer =
      this.utilsService.getNativeElement(
        this.componentConfig.inputElementContainer
      ) ||
      this.elemRef.nativeElement.querySelector('.mod-input-container') ||
      document.body;
  }
  ...
  init() {
    ...
    this.dayTimeCalendarConfig = this.dayPickerService.getDayTimeConfigService(
      this.componentConfig
    );
    this.timeSelectConfig = this.dayPickerService.getTimeConfigService(
      this.componentConfig
    );
    this.initValidators();
  }
  ...
  onViewDateChange(value: CalendarValue) {
    ...
    if (
      ...
      this.selected = this.dayPickerService.convertInputValueToMomentArray(
        strVal,
        this.componentConfig
      );
  ...
  moveCalendarTo(date: SingleCalendarValue) {
    const momentDate = this.utilsService.convertToMoment(
      date,
      this.componentConfig.format
    );
