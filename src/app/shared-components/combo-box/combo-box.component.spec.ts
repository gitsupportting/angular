...
import { ComboBoxDirective } from './combo-box-keyboard.directive';
...
describe('ComboBoxComponent', () => {
  ...
  beforeEach(async(() => {
    TestBed.configureTestingModule({
      declarations: [ComboBoxDirective, ComboBoxComponent, ComboBoxFilterPipe],
      imports: [FormsModule],
  ...
  describe('onItemClicked', () => {
    ...
    it('itemChanged should not be called with isMultiple = true', () => {
      ...
      component.onItemClicked(selectedItem, eventMock);
