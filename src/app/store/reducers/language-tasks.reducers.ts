...
import { TaskOutput, TaskOutputItems } from 'language-tasks-swagger-client';
...
const languageTasksReducer = createReducer(
  initialState,
  on(LanguageTasksActions.successLanguageTasks, (state, { languageTasks }) => ({
    ...state,
    languageTasks,
  })),
  ...
  on(
    ...
    (state, { languageTaskDetails }) => ({ ...state, languageTaskDetails })
  ),
...
export const getLanguageTasksData = (state: IAppState) =>
  state.languageTasksData;

export const _getLanguageTasks = createSelector(
  getLanguageTasksData,
  (languageTasksData) => {
    return languageTasksData ? languageTasksData.languageTasks : [];
  }
);

export const _getLanguageTaskDetails = createSelector(
  getLanguageTasksData,
  (languageTasksData) => {
    return languageTasksData ? languageTasksData.languageTaskDetails : [];
  }
);
